...
export default function InfoPanel({ selectedPart, onSelectPart }) {
    ...
    <div className="info-panel visible">
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '1rem' }}>
        ...
        <button
          ...
          style={{ background: 'none', border: 'none', color: '#94a3b8', cursor: 'pointer', fontSize: '1.25rem', padding: '0 4px' }}
        >
          ✕
        </button>
      </div>
